...
if __name__ == "__main__":
    ...
    for r in [80]:
        for num in [2,3,4]:
            ...
            Image.fromarray((image_circle * 255).astype('uint8'), mode='L').convert('RGB').save(str(r)+str(num)+'testcircle.png')
            Image.fromarray((image_square * 255).astype('uint8'), mode='L').convert('RGB').save(str(r)+str(num)+'testsquare.png')
            Image.fromarray((image_tangle * 255).astype('uint8'), mode='L').convert('RGB').save(str(r)+str(num)+'testangle.png')
            Image.fromarray((image_rot_circle * 255).astype('uint8'), mode='L').convert('RGB').save(str(r)+str(num)+'testcircle90.png')
            Image.fromarray((image_rot_square * 255).astype('uint8'), mode='L').convert('RGB').save(str(r)+str(num)+'testsquare90.png')
            Image.fromarray((image_rot_tangle * 255).astype('uint8'), mode='L').convert('RGB').save(str(r)+str(num)+'testtangle90.png')
            Image.fromarray((image_rot_tangle * 255).astype('uint8'), mode='L').convert('RGB').save(str(r)+str(num)+'testtangle90.png')
